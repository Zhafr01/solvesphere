...
export default function Edit({ auth, forumTopic }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('forum-topics.update', forumTopic.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Topic</h2>}
        >
